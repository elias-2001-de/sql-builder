...
fn where_clause_eq() {
    ...
    QueryBuilder::new()
        ...
        .execute_all(&runner)
        .unwrap();
    assert_eq!(runner.query().unwrap(), "SELECT * FROM users WHERE (UserId = 1)");
}
...
fn where_clause_gt_and_lt() {
    ...
    QueryBuilder::new()
        ...
        .execute_all(&runner)
        .unwrap();
    assert_eq!(runner.query().unwrap(), "SELECT * FROM posts WHERE (PostId > 10 AND PostId < 50)");
}
...
fn where_clause_not_eq_and_lt_eq() {
    ...
    QueryBuilder::new()
        ...
        .execute_all(&runner)
        .unwrap();
    assert_eq!(runner.query().unwrap(), "SELECT * FROM users WHERE (UserId <> 0 AND UserId <= 99)");
}
...
fn where_clause_gt_eq() {
    ...
    QueryBuilder::new()
        ...
        .execute_all(&runner)
        .unwrap();
    assert_eq!(runner.query().unwrap(), "SELECT * FROM posts WHERE (PostId >= 100)");
}
...
fn where_clause_like() {
    ...
    QueryBuilder::new()
        ...
        .execute_all(&runner)
        .unwrap();
    assert_eq!(runner.query().unwrap(), "SELECT * FROM users WHERE (UserName LIKE '%alice%')");
}
...
fn where_clause_is_null() {
    ...
    QueryBuilder::new()
        ...
        .execute_all(&runner)
        .unwrap();
    assert_eq!(runner.query().unwrap(), "SELECT * FROM users WHERE (Email IS NULL)");
}
...
fn where_clause_is_not_null() {
    ...
    QueryBuilder::new()
        ...
        .execute_all(&runner)
        .unwrap();
    assert_eq!(runner.query().unwrap(), "SELECT * FROM posts WHERE (Draft IS NOT NULL)");
}
...
fn where_clause_is_not_null_on_nullable_fk() {
    ...
    QueryBuilder::new()
        ...
        .execute_all(&runner)
        .unwrap();
    assert_eq!(runner.query().unwrap(), "SELECT * FROM comments WHERE (ParentId IS NOT NULL)");
}
...
fn where_clause_and_chain() {
    ...
    QueryBuilder::new()
        ...
        .execute_all(&runner)
        .unwrap();
    assert_eq!(runner.query().unwrap(), "SELECT * FROM users WHERE (UserId = 1 AND UserName LIKE '%alice%')");
}
...
fn where_clause_or_chain() {
    ...
    QueryBuilder::new()
        ...
        .execute_all(&runner)
        .unwrap();
    assert_eq!(runner.query().unwrap(), "SELECT * FROM users WHERE (UserId < 10 OR UserId >= 100)");
}
...
fn where_clause_between() {
    ...
    QueryBuilder::new()
        ...
        .execute_all(&runner)
        .unwrap();
    assert_eq!(runner.query().unwrap(), "SELECT * FROM users WHERE (UserId BETWEEN 1 AND 50)");
}
...
fn where_clause_in_values() {
    ...
    QueryBuilder::new()
        ...
        .execute_all(&runner)
        .unwrap();
    assert_eq!(runner.query().unwrap(), "SELECT * FROM users WHERE (UserId IN (1, 2, 3))");
}
...
fn where_clause_multiple_calls_and_joined() {
    ...
    QueryBuilder::new()
        ...
        .execute_all(&runner)
        .unwrap();
    assert_eq!(runner.query().unwrap(), "SELECT * FROM posts WHERE (PostId > 5) AND (Draft IS NULL)");
}
